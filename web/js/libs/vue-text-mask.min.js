!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.vueTextMask = t() : e.vueTextMask = t()
}(this, function () {
    return function (e) {
        function t(n) {
            if (r[n])
        ...
        , function (e, t, r) {
            ...
            function n() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a
                    ...
                    , c = r.placeholder
                    , p = void 0 === c ? (0,
                        o.convertMaskToPlaceholder)(t, f) : c
                    ...
                    , O = x + Math.abs(k);
                if (v === !0 && !P) {
                    for (var M = a, T = x; T < O; T++)
                        p[T] === f && (M += f);
                    e = e.slice(0, x) + M + e.slice(x, g)
                }
                ...
                if (m && P === !1) {
                    for (var L = null, W = 0; W < _.length; W++)
                        p[W] === f && (L = W);
                    _ = null !== L ? _.substr(0, L + 1) : a
                }
                return {
                    conformedValue: _,
                    meta: {
        ...
        , function (e, t, r) {
            ...
            function a(e) {
                for (var t = [], r = void 0; r = e.indexOf(l),
                    r !== -1;)
                    t.push(r),
                        e.splice(r, 1);
                return {
            ...
            function r(e) {
                ...
                if (M)
                    ...
                    var N = a.substr(0, E.length).split(o).filter(function (e) {
                        ...
                        , q = c.substr(0, E.length).split(o).filter(function (e) {
                            return e !== f
                        }).length
                        , A = q !== N
                        , I = void 0 !== a[E.length - 1] && void 0 !== c[E.length - 2] && a[E.length - 1] !== f && a[E.length - 1] !== c[E.length - 1] && a[E.length - 1] === c[E.length - 2];
                    !P && (A || I) && N > 0 && c.indexOf(j) > -1 && void 0 !== d[s] && (w = !0,
                        j = d[s]);
                    for (var $ = h.map(function (e) {
                        return V[e]
                    }), B = $.filter(function (e) {
                        return e === j
                    }).length, F = E.filter(function (e) {
                        return e === j
                    }).length, R = c.substr(0, c.indexOf(f)).split(o).filter(function (e, t) {
                        return e === j && d[t] !== e
                    }).length, J = R + F + B + (w ? 1 : 0), L = 0, W = 0; W < C; W++) {
                        var D = V[W];
                        if (T = W + 1,
                            D === j && L++ ,
                            L >= J)
                ...
                if (P) {
                    for (var z = T, G = T; G <= b; G++)
                        if (c[G] === f && (z = G),
                            c[G] === f || m.indexOf(G) !== -1 || G === b)
                            return z
                } else if (w) {
                    for (var H = T - 1; H >= 0; H--)
                        if (l[H] === j || m.indexOf(H) !== -1 || 0 === H)
                            return H
                } else
                    for (var K = T; K >= 0; K--)
                        if (c[K - 1] === f || m.indexOf(K) !== -1 || 0 === K)
                            return K
            }
            Object.defineProperty(t, "__esModule", {
                value: !0
                ...
                return {
                    ...
                    update: function (r) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e
                            ...
                            , g = n.pipe
                            , b = n.placeholderChar
                            , C = void 0 === b ? h.placeholderChar : b
                            , k = n.keepCharPositions
                            , P = void 0 !== k && k
                            , x = n.showMask
                            , O = void 0 !== x && x;
                        if ("undefined" == typeof r && (r = o.value),
                            r !== t.previousConformedValue) {
                            ("undefined" == typeof l ? "undefined" : s(l)) === y && void 0 !== l.pipe && void 0 !== l.mask && (g = l.pipe,
                                l = l.mask);
                            var M = void 0
                                , T = void 0;
                            if (l instanceof Array && (M = (0,
                                p.convertMaskToPlaceholder)(l, C)),
                                l !== !1) {
                                var w = a(r)
                                    , j = o.selectionEnd
                                    , V = t.previousConformedValue
                                ...
                                if (("undefined" == typeof l ? "undefined" : s(l)) === v) {
                                    if (T = l(w, {
                                        ...
                                        return;
                                    var E = (0,
                                        p.processCaretTraps)(T)
                                        , N = E.maskWithoutCaretTraps
                                        , q = E.indexes;
                                    T = N,
                                        _ = q,
                                        M = (0,
                                            p.convertMaskToPlaceholder)(T, C)
                                } else
                                    T = l;
                                var A = {
                                    previousConformedValue: V,
